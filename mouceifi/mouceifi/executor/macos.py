"""
macOS-specific mouse executor (stub for future implementation).
"""
...
class MacOSMouseExecutor(MouseExecutor):
    """
    macOS mouse executor (placeholder).

    For production implementation, consider:
    - pyautogui (cross-platform, works on macOS)
    - Quartz (via pyobjc-framework-Quartz)
    ...
    def __init__(self, dry_run: bool = False):
        ...
        raise NotImplementedError(
            "macOS executor not yet implemented. "
            "To implement, use pyautogui or pyobjc-framework-Quartz."
        )
